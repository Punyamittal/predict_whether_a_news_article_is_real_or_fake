"""
Training script for Predict whether a news article is real or fake.
...
with open('classification_model_20260131_155412.pkl', 'wb') as f:
    pickle.dump({
        'model': model,
        'scaler': scaler,
...
print(f"Model trained and saved to classification_model_20260131_155412.pkl")
